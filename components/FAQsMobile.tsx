      ...
      <main className="pt-24 pb-8 px-4">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8">
            <h1 className="text-4xl font-black text-mello-light mb-3">
          ...
          <div className="space-y-6">
            {faqSections.map((section, sectionIndex) => (
              <div key={sectionIndex} className="bg-white/5 rounded-xl p-4 backdrop-blur-sm border border-white/10">
                <h2 className="text-lg font-bold text-mello-yellow mb-4">
                  {section.title}
                </h2>
                  ...
                  {section.faqs.map((faq, faqIndex) => {
                    ...
                    return (
                      <div key={faqIndex} className="border border-white/10 rounded-lg overflow-hidden">
                        ...
                        >
                          <span className="font-semibold text-white text-sm pr-3 leading-tight">
                            {faq.question}
                          </span>
                          <svg
                            className={`w-4 h-4 text-mello-yellow transition-transform flex-shrink-0 ${
                              isOpen ? 'rotate-180' : ''
                            }`}
                            fill="none"
                            viewBox="0 0 24 24"
